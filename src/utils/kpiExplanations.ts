...
export const kpiExplanations: Record<KpiKey, Explanation> = {
  ...
  totalBaixado: { formula: 'Soma dos rateios com status Baixado ou Baixado Parcialmente.', fields: 'VLRRATEIO, STATUS_FIN', limit: 'Inclui o rateio integral das linhas parcialmente baixadas. Não é a soma dos eventos de recebimento ou pagamento; não somar novamente o card Baixado parcialmente. ' + currentStatus, reference: 'status' },
